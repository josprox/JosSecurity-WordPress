...
if(isset($_POST['instalar'])){
  ...
  $sqlScript = file('jossecurity.sql');
        ...
        <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="post">
          ...
          <p align="justify">Por defecto el sistema maneja el nombre de JosSecurity y la versión preliminar del mismo pero, si tu quieres modificarlo podrás hacerlo, de esta manera también evitarás que las personas conozcan el sistema de seguridad que usas.</p>
            ...
            <div class="row justify-content-center">
              ...
              <p align="justify">El sistema ya integra un jossito para poder usar Mercado pago para y ejecutar pagos, podrás modificarlo después en el archivo env.</p>

              <div class="row justify-content-center">

                <div class="col-10">
                  <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" id="MP" name="MP">
                    <label class="form-check-label" for="MP"> ¿Desea activar el sistema Mercado Pago?</label>
                  </div>
                </div>
                ...
                <div class="col-5">
                  <div class="mb-3">
                    ...
                    <input type="text"
                      class="form-control" name="MPPK" id="MPPK" aria-describedby="MPPK" placeholder="Pon la llave">
